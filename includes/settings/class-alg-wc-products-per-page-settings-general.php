	...
	function get_settings() {
			...
			$settings = array_merge( $settings, array(
				array(
					'desc'     => sprintf(
						...
						__( 'Position priority: %s', 'products-per-page-for-woocommerce' ),
						'<em>' . ( $positions[ $position ] ?? $position ) . '</em>'
					),
		...
		$settings = array_merge( $settings, array(
			array(
				...
				'desc_tip'          => (
					__( 'You can list custom WordPress actions here.', 'products-per-page-for-woocommerce' ) . ' ' .
					__( 'One per line.', 'products-per-page-for-woocommerce' ) . ' ' .
					sprintf(
						/* Translators: %s: Example. */
						__( 'If you want to set the priority for the action, use vertical bar symbol, e.g.: %s', 'products-per-page-for-woocommerce' ),
			...
			array(
				...
				'desc_tip'          => (
					sprintf(
						...
						__( 'Will add "%1$s" widget to %2$s.', 'products-per-page-for-woocommerce' ),
					...
					apply_filters(
						...
						'<br>' . 'You will need <a href="https://wpfactory.com/item/products-per-page-woocommerce/" target="_blank">Number of Products per Page - Pagination Manager for WooCommerce Pro</a> plugin to enable this option.'
					)
				),
			...
			array(
				...
				'desc'                => sprintf(
					...
					__( 'Available placeholders: %s.', 'products-per-page-for-woocommerce' ),
				...
				'default'             => __( 'Products <strong>%from% - %to%</strong> from <strong>%total%</strong>. Products on page %dropdown%', 'products-per-page-for-woocommerce' ), // phpcs:ignore WordPress.WP.I18n.UnorderedPlaceholdersText, WordPress.WP.I18n.MissingTranslatorsComment
				'type'                => 'textarea',
				'css'                 => 'width:100%;',
			),
			array(
				...
				'desc'                => sprintf(
					/* Translators: %1$s: Placeholder name, %2$s: HTML tag, %3$s: Placeholder name, %4$s: HTML tag. */
					__( 'In case of %1$s it is applied to each %2$s tag. In case of %3$s it is applied to the %4$s tag.', 'products-per-page-for-woocommerce' ),
					'<code>%radio%</code>',
					'<code>' . esc_html( '<input>' ) . '</code>',
					'<code>%dropdown%</code>',
					'<code>' . esc_html( '<select>' ) . '</code>'
				),
			...
			array(
				...
				'desc'                => sprintf(
					...
					__( 'This is used for the %s placeholder - to "glue" the radio buttons.', 'products-per-page-for-woocommerce' ),
					'<code>%radio%</code>'
				),
