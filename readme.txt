...
= 2.5.6 - 21/08/2026 =
* Dev - Advanced Options - Scopes - Functions allow-listed.
* Dev - WPFactory Cross-Selling - Library updated (to v1.1.4).
...
* Dev - `alg-wc-products-per-page-form` HTML class added.
* Dev - WooCommerce "Pagination" template updated.
* Dev - Code refactoring.
* WC tested up to: 9.3.
